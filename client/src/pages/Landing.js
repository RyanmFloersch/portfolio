    ...
    return (
        <main className=" text-emerald-200">
            ...
            <section className='hero m-5 '>
                ...
                <br></br>
                <p className='text-center'>I'm currently completing a web development bootcamp. I am always interested in learning more and I'm excited to apply that knowledge within a professional environment.</p>
