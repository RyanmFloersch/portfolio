    ...
    return (
        ...
        <div className="flex md:flex-row flex-col md:justify-start   ">
            <div className="flex flex-row justify-between items-center px-2   ">
                ...
                <a href="/" className="tracking-widest hover:underline underline-offset-2 decoration-emerald-700 text-emerald-200" >Ryan Floersch</a>
            ...
            <div className="hidden  items-center w-full md:block md:w-auto  md:bg-transparent bg-slate-800 " id="navbar-default">
                ...
                <ul className="text-emerald-200 font-medium  flex flex-col justify-start  md:p-0 md:ml-8 md:bg-transparent bg-neutral-500 border border-gray-100 md:divide-none divide-y   md:flex-row md:space-x-8 mt-0 md:border-0   ">
                    ...
                    <a href="mailto: ryanmichaelfloersch@gmail.com" className="block  py-2 pl-3 pr-4  rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Contact</a>
                    <a href="Ryan Floersch Resume.pdf" className="block  py-2 pl-3 pr-4  rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Resume</a>
