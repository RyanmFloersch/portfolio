...
//     console.log('test');
// }
import CarsoulProject from '../components/CarouselProject';
            ...
            <div id="animation-carousel" className="relative w-full h-full" data-carousel="static">
                ...
                <div className="relative h-96 overflow-hidden rounded-lg md:h-96">
                    ...
                    <div className="hidden  duration-200 ease-linear" data-carousel-item="active">
                        <CarsoulProject urlLink={"https://github.com/RyanmFloersch/BowlCrawl"} projectName={"Bowl Crawl"} image={"/BowlMap.png"} alt={"image of bowl crawl website"} project={project_1} />

                    </div>

                    {/* <!-- Item 2 --> */}
                    <div className="hidden  duration-200 ease-linear" data-carousel-item>
                        <CarsoulProject urlLink={"https://github.com/RyanmFloersch/Realtor_App"} projectName={"House Hunter"} image={"/HouseHunter.png"} alt={"image of house hunter website login page"} project={project_2} />


                    </div>
                    {/* <!-- Item 3 --> */}
                    <div className="hidden duration-200 ease-linear" data-carousel-item>
                        <CarsoulProject urlLink={"https://github.com/AustinL96/daedalus_roster"} projectName={"Daedalus Roster"} image={"/HouseHunter.png"} alt={"image of daedulus roster website login page"} project={project_3} />
                    </div>
                    {/* <!-- Item 4 --> */}
